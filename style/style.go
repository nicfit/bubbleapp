...
func NewAppTheme(colors Colors) *AppTheme {
	...
	return &AppTheme{
		...
		Text: map[Variant]map[ComponentState]lipgloss.Style{
			Primary: {
				Normal:   lipgloss.NewStyle().Foreground(colors.Primary),
			...
			Secondary: {
				Normal:   lipgloss.NewStyle().Foreground(colors.Secondary),
			...
			Tertiary: {
				Normal:   lipgloss.NewStyle().Foreground(colors.Tertiary),
			...
			Success: {
				Normal:   lipgloss.NewStyle().Foreground(colors.Success),
