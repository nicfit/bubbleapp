...
func DefaultStyles() *Styles {
	...
	s.ButtonCompact = ButtonStyles{
		...
		PrimaryFocused:   lipgloss.NewStyle().Background(s.Colors.Primary).Foreground(s.Colors.White),
		SecondaryFocused: lipgloss.NewStyle().Background(s.Colors.Secondary).Foreground(s.Colors.White),
		...
		DangerFocused:    lipgloss.NewStyle().Background(s.Colors.Danger).Foreground(s.Colors.White),
		...
		PrimaryHovered:   lipgloss.NewStyle().Background(s.Colors.PrimaryLight).Foreground(s.Colors.White),
		SecondaryHovered: lipgloss.NewStyle().Background(s.Colors.SecondaryLight).Foreground(s.Colors.White),
		...
		DangerHovered:    lipgloss.NewStyle().Background(s.Colors.DangerLight).Foreground(s.Colors.White),
